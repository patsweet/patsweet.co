...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyMember.deathday'
        db.add_column(u'genealogy_familymember', 'deathday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilyMember.deathday'
        db.delete_column(u'genealogy_familymember', 'deathday')
