...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyMember.middle_name'
        db.add_column(u'family_tree_familymember', 'middle_name',
    ...
    def backwards(self, orm):
        # Deleting field 'FamilyMember.middle_name'
        db.delete_column(u'family_tree_familymember', 'middle_name')
    ...
    models = {
        u'family_tree.familymember': {
            ...
            'suffix_name': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True', 'blank': 'True'})
        }
    }
