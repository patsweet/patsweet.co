...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FamilyMember.sex'
        db.add_column(u'family_tree_familymember', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FamilyMember.sex'
        db.delete_column(u'family_tree_familymember', 'sex')
